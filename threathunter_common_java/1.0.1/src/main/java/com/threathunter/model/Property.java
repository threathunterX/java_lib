...
public class Property<P extends Property> {
    ...
    public static Property from_json_object(Object object) {
        ...
        Object identifierObj = mObject.get("identifier");
        Identifier identifier;
        if (identifierObj == null) {
            identifier = null;
        } else {
            identifier = Identifier.from_json_object(identifierObj);
        }
        return new Property(identifier, name, NamedType.from_json_object(type));
    }
