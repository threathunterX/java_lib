...
public abstract class PropertyReduction {
    ...
    public static void init() {
        String[] packages = CommonDynamicConfig.getInstance().getStringArray("nebula.propertyreduction.packages");
        if (packages != null) {
    ...
    public PropertyReduction(List<Property> srcProperties, Property destProperty, String type) {
        this.srcProperties = srcProperties;
        this.destProperty = destProperty;
        this.type = type;
    }

    public PropertyReduction(Property srcProperty, Property destProperty, String type) {
        this(Arrays.asList(srcProperty), destProperty, type);
    }
