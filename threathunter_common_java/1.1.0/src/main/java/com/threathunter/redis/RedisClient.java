...
public class RedisClient implements RedisTagCommands, RedisCommands {
    ...
    // TODO pipeline should set the consistent key, if client invoke with tag, all the key includes pipeline need to set taggedKey
    ...
    public RedisPipeline getPipeline(String key) {
        ...
        return new RedisPipeline(this.redisPool.getResource(builder.toString()), builder.toString(), true);
    }
