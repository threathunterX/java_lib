...
public class AggregateVariableMeta extends BaseVariableMeta {
    ...
    private PropertyReduction reduction;
    ...
    public PropertyReduction getReduction() {
        return reduction;
    }
    ...
    protected void parseFunction(Map<String, Object> functionJson) {
        ...
        this.reduction = PropertyReduction.from_json_object(ReductionParser.parseFrom(functionJson, this.srcVariableMetasID.get(0), this.id));
    }
    ...
    protected NamedType parseValueType() {
        return this.reduction.getDestProperty().getType();
    }
