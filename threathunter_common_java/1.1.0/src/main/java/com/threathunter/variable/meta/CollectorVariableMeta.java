...
public class CollectorVariableMeta extends BaseVariableMeta {
    ...
    protected void parseFunction(Map<String, Object> functionJson) {
        ...
        this.srcVariableMetasID.forEach(srcId -> {
            ...
            if (onlyValueNeeded) {
                ...
                mappings.add(new VariablePropertyMapping(meta, new Property(this.id, meta.getName(), NamedType.MAP, NamedType.OBJECT)));
            }
        });
    ...
    protected List<Property> parseProperties() {
        ...
        this.mappings.forEach(mapping -> {
            ...
            propertyList.add(new Property(id, destProperty.getName(), destProperty.getType(), destProperty.getSubType()));
        });
        return propertyList;
    }
